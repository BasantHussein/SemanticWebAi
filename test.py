...
def Search():
    ...
    if match1:
        ...
        res += "here is all the horror movies that we recommend to you"
        for lab, row in horror.iterrows():
            print("The Title : " + row['Title'])
            res += "The Title : " + row['Title']
            print("The wiki page : " + row['Wiki Page'])
            res += "The wiki page : " + row['Wiki Page']

    elif match2:
        print("here is all the drama movies that we recommend to you")
        res += "here is all the drama movies that we recommend to you"
        ...
        res += "here is all the action movies that we recommend to you"
        for lab, row in action.iterrows():
            rint("The Title : " + row['Title'])
            res += "The Title : " + row['Title']
            print("The wiki page : " + row['Wiki Page'])
            res += "The wiki page : " + row['Wiki Page']
        ...
        res += "here is all the comedy movies that we recommend to you"
        ...
        res += "here is all the adventure movies that we recommend to you"
        ...
        res += "The " + fname + " Cast : " + desc['Cast']
        print("and for more information you can check the wikipage : " + desc['Wiki Page'])
        res += "and for more information you can check the wikipage : " + desc['Wiki Page']
        ...
        res += "The " + fname + " Director is : " + desc['Director']
        print("and for more information you can check the wikipage : " + desc['Wiki Page'])
        rse += "and for more information you can check the wikipage : " + desc['Wiki Page']
        ...
        res += fname + " is " + desc['Origin/Ethnicity']
        print("and for more information you can check the wikipage : " + desc['Wiki Page'])
        res += "and for more information you can check the wikipage : " + desc['Wiki Page']
        ...
        res += fname + " released on  " + desc['Release Year']
        print("and for more information you can check the wikipage : " + desc['Wiki Page'])
        res += "and for more information you can check the wikipage : " + desc['Wiki Page']
        ...
        print(Movies['Title'])
        res += "There's our available movies:D : "
        res += Movies['Title']
    else :
        print("not found")
        print("but these is our recommendation : Movies['Title']")
        res += "not found"
        res += "but these is our recommendation : Movies['Title']"
